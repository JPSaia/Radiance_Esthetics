document.addEventListener("DOMContentLoaded", function () {
    ...
    const serviceDescriptions = {
          "Facials": "Facials can combat skin concerns (such as skin discoloration, acne & irritation, scarring, anti-aging, maintain a healthy skin complexion) all while increasing self care, and promoting relaxation. ",
        ...
        "Chemical Peels": "A chemical peel is a technique used to improve and smooth the texture of the skin while improving scarring, fine lines and wrinkles.",
        ...
        "Microneedling": "Microneedling is a cosmetic procedure used to encourage collagen production. Microneedling will help smooth, firm, and tone skin while improving the appearance of scars, acne, and wrinkles.",
        ...
        "Skin rejuvenation with PRFM": "The PRFM (platelet-rich fibrin matrix)  method is a process of extracting platelets from the blood to fill out wrinkles.",
